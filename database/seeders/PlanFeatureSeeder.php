        ...
        $features = [
            ...
            [
                ...
                'features' => [
                    ...
                    ['name' => 'Storage', 'value' => '1GB', 'sort_order' => 4],
                    ['name' => 'API Access', 'value' => 'false', 'sort_order' => 5],
            ...
            [
                ...
                'features' => [
                    ...
                    ['name' => 'Storage', 'value' => '10GB', 'sort_order' => 4],
                    ['name' => 'API Access', 'value' => 'true', 'sort_order' => 5],
                    ['name' => 'Priority Support', 'value' => 'true', 'sort_order' => 6],
                    ['name' => 'Custom Domain', 'value' => 'true', 'sort_order' => 7],
            ...
            [
                ...
                'features' => [
                    ...
                    ['name' => 'Storage', 'value' => '100GB', 'sort_order' => 4],
                    ['name' => 'API Access', 'value' => 'true', 'sort_order' => 5],
                    ['name' => 'Priority Support', 'value' => 'true', 'sort_order' => 6],
                    ['name' => 'Custom Domain', 'value' => 'true', 'sort_order' => 7],
                    ['name' => 'Advanced Analytics', 'value' => 'true', 'sort_order' => 8],
                    ['name' => 'Custom Branding', 'value' => 'true', 'sort_order' => 9],
            ...
            [
                ...
                'features' => [
                    ...
                    ['name' => 'Projects', 'value' => 'Unlimited', 'sort_order' => 2],
                    ['name' => 'Tasks', 'value' => 'Unlimited', 'sort_order' => 3],
                    ['name' => 'Storage', 'value' => '1TB', 'sort_order' => 4],
                    ['name' => 'API Access', 'value' => 'true', 'sort_order' => 5],
                    ['name' => 'Priority Support', 'value' => 'true', 'sort_order' => 6],
                    ['name' => 'Custom Domain', 'value' => 'true', 'sort_order' => 7],
                    ['name' => 'Advanced Analytics', 'value' => 'true', 'sort_order' => 8],
