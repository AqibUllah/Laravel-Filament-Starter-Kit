            ...
            <div class="text-center space-y-5">
                ...
                <div class="space-y-4">
                    <h1 class="text-4xl font-bold text-gray-900 dark:text-white">
                        {{ $this->isPlanSwitch ? 'Plan Updated Successfully!' : 'Welcome to ' . $this->planName . '!' }}
                    </h1>
                    <p class="text-xl text-gray-600 dark:text-gray-300">
                        {{ $this->isPlanSwitch ? 'Your plan has been switched successfully' : 'Your subscription is now active and ready to use' }}
                    </p>
                </div>
                ...
                <div class="bg-gradient-to-r from-primary-500 to-blue-600 rounded-2xl p-6 text-white shadow-xl">
                    <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-3 xs:grid-cols-2 gap-6 text-center md:text-left">
                        <div class="space-y-2">
                            ...
                            <p class="text-2xl font-bold">{{ $this->subscription->plan->name }}</p>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="text-2xl font-bold">${{ $this->subscription->plan->price }}/{{ $this->subscription->plan->interval }}</p>
                        </div>
                    </div>
                    ...
                    @if($this->subscription->isOnTrial())
                        <div class="mt-4 p-3 bg-white/10 rounded-lg backdrop-blur-sm">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <span class="font-medium">Trial Ends: {{ $this->subscription->trial_ends_at->format('M j, Y') }}</span>
                            </div>
                        </div>
                    @endif
                </div>
            ...
            <div class="text-center space-y-6 py-8">
                ...
                <div class="flex justify-center gap-4 pt-4">
                    <x-filament::button
                        ...
                        color="warning"
                        size="lg"
                        class="flex items-center space-x-2 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600">
