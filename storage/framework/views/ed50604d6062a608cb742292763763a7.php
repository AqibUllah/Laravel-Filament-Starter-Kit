...
<?php endif; ?>
            ...
            >
                <!--[if BLOCK]><![endif]--><?php if($currentTenant instanceof \Filament\Models\Contracts\HasCurrentTenantLabel): ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($itemsBeforeTenantSwitcher->isNotEmpty()): ?>
...
<?php $component->withAttributes([]); ?>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $itemsBeforeTenantSwitcher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($item); ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($canSwitchTenants): ?>
        <div x-data="{ search: '' }">
            <?php if (isset($component)) { $__componentOriginal66687bf0670b9e16f61e667468dc8983 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66687bf0670b9e16f61e667468dc8983 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.list.index','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($itemsAfterTenantSwitcher->isNotEmpty()): ?>
        <?php if (isset($component)) { $__componentOriginal66687bf0670b9e16f61e667468dc8983 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal66687bf0670b9e16f61e667468dc8983 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.dropdown.list.index','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('filament::dropdown.list'); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $itemsAfterTenantSwitcher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($item); ?>
...
<?php /**PATH /Users/aqibullah/developement/Laravel/filament-saas-starter-kit/vendor/filament/filament/resources/views/components/tenant-menu.blade.php ENDPATH**/ ?>