...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <title><?php echo e(config('app.name', 'Laravel Filament Starter Kit')); ?> - Multi-Tenant SaaS Platform</title>
...
<body class="bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 antialiased">
    ...
    <nav class="fixed top-0 w-full z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
            ...
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center">
                    <span class="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">
                        <?php echo e(config('app.name', 'SaaS Kit')); ?>
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <?php if(Route::has('login')): ?>
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition">
                                Dashboard
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 transition">
                                Log in
                            </a>
                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 bg-purple-600 text-white dark:text-gray-800 rounded-lg hover:bg-purple-700 transition">
                                    Get Started
                                </a>
                            <?php endif; ?>
                        <?php endif; ?>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
            ...
            <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="block px-4 py-2 bg-purple-600 text-white rounded-lg text-center">
                            Dashboard
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="block text-gray-700 dark:text-gray-300">Log in</a>
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="block px-4 py-2 bg-purple-600 text-white dark:text-gray-800 rounded-lg text-center">
                                Get Started
                            </a>
                        <?php endif; ?>
                    <?php endif; ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="text-center animate-fade-in-up">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <?php if(Route::has('register')): ?>
                        <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-white text-purple-600 rounded-lg font-semibold hover:bg-gray-100 transition shadow-lg">
                            Start Free Trial
                        </a>
            <?php endif; ?>
            ...
            <div class="grid gap-10 lg:grid-cols-2">
                <article class="bg-white dark:bg-gray-900 shadow-xl rounded-3xl overflow-hidden border border-gray-100 dark:border-gray-800 transition hover:-translate-y-1 hover:shadow-2xl">
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <a
                                href="<?php echo e(Route::has('filament.tenant.auth.login') ? route('filament.tenant.auth.login') : (Route::has('login') ? route('login') : '#')); ?>"
                ...
                <article class="bg-white dark:bg-gray-900 shadow-xl rounded-3xl overflow-hidden border border-gray-100 dark:border-gray-800 transition hover:-translate-y-1 hover:shadow-2xl">
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            <a
                                href="<?php echo e(Route::has('filament.admin.auth.login') ? route('filament.admin.auth.login') : (Route::has('login') ? route('login') : '#')); ?>"
            ...
            <div class="grid md:grid-cols-3 gap-8 items-stretch">
                ...
                <div class="relative group h-full">
                    ...
                    <div class="relative flex h-full flex-col bg-white dark:bg-gray-900 rounded-2xl p-8 shadow-[0_40px_120px_-40px_rgba(79,70,229,0.35)] dark:shadow-[0_40px_120px_-50px_rgba(79,70,229,0.45)] border border-gray-100 dark:border-gray-800 transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_45px_140px_-40px_rgba(99,102,241,0.45)] dark:hover:shadow-[0_45px_140px_-45px_rgba(129,140,248,0.55)] hover:border-purple-200 dark:hover:border-purple-500 <?php echo e($plan->is_featured ? 'border-2 border-purple-500 shadow-[0_45px_140px_-35px_rgba(124,58,237,0.55)] scale-105 hover:border-purple-400 dark:hover:border-purple-400' : ''); ?>">
                        ...
                        <div class="mb-6">
                            <span class="text-4xl font-bold">$<?php echo e($plan->price); ?></span>
                            <span class="text-gray-600 dark:text-gray-400">/<?php echo e($plan->interval); ?></span>
                        </div>
                        <ul class="space-y-3 mb-8 flex-1">
                            <?php $__currentLoopData = json_decode($plan->features); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="flex items-center">
                                    ...
                                    <?php if(is_bool($feature->value)): ?>
                                        <?php if(is_bool($feature->value) && $feature->value): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-5 w-5 text-success-500']); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-5 w-5 text-danger-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                        ...
                        <a href="<?php echo e(Route::has('filament.tenant.auth.register') ? route('filament.tenant.auth.register') : '#'); ?>" class="block w-full text-center dark:text-gray-800 px-6 py-3 rounded-lg font-semibold transition duration-300 <?php echo e($plan->is_featured ? 'bg-purple-600 text-white dark:hover:text-gray-200 group-hover:bg-purple-700' : 'bg-gray-200 text-gray-700 group-hover:bg-purple-100 group-hover:text-purple-600'); ?>">
                            Get Started
                        </a>
                    </div>
                </div>
    ...
    <section class="section-padding gradient-bg-2 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <?php if(Route::has('register')): ?>
                    <a href="<?php echo e(route('register')); ?>" class="px-8 py-4 bg-white text-pink-600 rounded-lg font-semibold hover:bg-gray-100 transition shadow-lg">
                        Start Free Trial
                    </a>
        <?php endif; ?>
                <a href="#features" class="px-8 py-4 bg-white/20 text-white rounded-lg font-semibold hover:bg-white/30 transition backdrop-blur-sm border border-white/30">
    ...
    <footer id="about" class="bg-gray-900 text-gray-300 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8 mb-8">
                <div>
                    <h3 class="text-white font-bold text-lg mb-4"><?php echo e(config('app.name', 'SaaS Kit')); ?></h3>
            ...
            <div class="border-t border-gray-800 pt-8 text-center text-gray-400">
                <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name', 'SaaS Kit')); ?>. All rights reserved.</p>
            </div>
        </div>
    </footer>
