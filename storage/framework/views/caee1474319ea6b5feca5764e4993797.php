    ...
    <div id="alert-additional-content-2"
        ...
        <div class="relative p-6">
            <div class="flex items-start justify-between gap-4">
                <div class="flex-1 min-w-0">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div class="flex-shrink-0">
                            <!--[if BLOCK]><![endif]--><?php if($type === 'danger'): ?>
                        ...
                        <div>
                            <h3 class="text-lg font-semibold <?php echo e(match($type) {
                            ...
                            <p class="text-sm <?php echo e(match($type) {
                ...
                <!--[if BLOCK]><![endif]--><?php if($upgradeUrl): ?>
                    <div class="flex-shrink-0">
                        <?php if (isset($component)) { $__componentOriginal6330f08526bbb3ce2a0da37da512a11f = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6330f08526bbb3ce2a0da37da512a11f = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament::components.button.index','data' => ['href' => $upgradeUrl,'size' => 'sm','color' => 'primary','tag' => 'a','class' => 'shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105 font-medium px-6 py-2.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($upgradeUrl),'size' => 'sm','color' => 'primary','tag' => 'a','class' => 'shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105 font-medium px-6 py-2.5']); ?>
...
<?php endif; ?>
        ...
        <div class="absolute bottom-0 left-0 right-0 h-1 <?php echo e(match($type) {
...
<?php /**PATH /Users/aqibullah/developement/Laravel/filament-saas-starter-kit/resources/views/filament/schemas/components/limit-alert.blade.php ENDPATH**/ ?>