...
return [
    ...
    'repository' => DatabaseSettingsRepository::class,

    /*
     * When no repository was set for a settings class the following repository
     * will be used for loading and saving settings.
     */
    'default_repository' => DatabaseSettingsRepository::class,

    // Database connection to use (null uses default)
    'connection' => null,
    ...
    'resolvers' => [
        'tenant_id' => [TenantResolver::class, 'tenantId'],
    ],

    // Register settings classes here
    'settings' => [
        App\Settings\TenantGeneralSettings::class,
    ],
